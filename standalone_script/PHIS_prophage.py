...
def phage_to_hosts(phage_file,phage_pro,outdir):
	...
	outfile_blastn_dict_file = os.path.join(outdir,'phage_blastn_prophage_result_dict')
	outfile_blastp_dict_file = os.path.join(outdir,'phage_blastp_prophage_result_dict')
